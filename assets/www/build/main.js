...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__trip_details_trip_details__ = __webpack_require__(78);
...
var SearchPage = /** @class */ (function () {
    function SearchPage(alertCtrl, menuCtrl, httpClient, loadingCtrl, navCtrl, navParams) {
    ...
    SearchPage.prototype.search = function () {
        ...
        loader.present();
        this.response = this.httpClient.get('https://voisibus.fr/api/get/search_trips.php?location=' + this.location);
        this.response
    ...
    SearchPage.prototype.toggleMenu = function () {
        this.menuCtrl.toggle();
    };
    SearchPage.prototype.openDetails = function (id) {
        console.log(id);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__trip_details_trip_details__["a" /* TripDetailsPage */], {
            id: id
        });
    };
    SearchPage.prototype.interestingTrip = function (id) {
        var alert = this.alertCtrl.create({
            title: 'Oh non !',
            subTitle: 'Désolé ! La demande de trajet via l\'application ne fonctionne pas encore mais sera bientôt disponible :)',
            buttons: ['OK']
        });
        alert.present();
    };
    SearchPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-search',template:/*ion-inline-start:"C:\Users\lucie\Desktop\VoisibusCovoiturageApplication\src\pages\search\search.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <button ion-button (click)="toggleMenu()" icon-only *ngIf="loggedIn">\n      <ion-icon name=\'menu\'></ion-icon>\n    </button>\n    <ion-title>\n      Rechercher\n    </ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-9>\n        <ion-item>\n          <ion-label floating>Ville</ion-label>\n          <ion-input type="text" [(ngModel)]="location"></ion-input>\n        </ion-item>\n      </ion-col>\n      <ion-col col-3>\n        <button style="margin-top: 18px;" ion-button (click)="search()" class="center" icon-only>\n          <ion-icon name="search"></ion-icon>\n        </button>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <br>\n  <ion-list no-lines>\n    <ion-card style="margin-top: 10px; margin-bottom: 10px;" ion-item *ngFor="let trip of trips">\n      <h2>{{ trip.title }}</h2>\n      <h3 (click)="openDetails(trip.id)">Départ: {{ trip.hour }}</h3>\n      <p>{{ trip.days.split(\';\').join(\' \') }}</p>\n      <button style="padding: 10px;" item-end ion-button icon-only outline color="primary" (click)="interestingTrip(trip.id)"><ion-icon name="checkmark"></ion-icon></button>\n    </ion-card>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\lucie\Desktop\VoisibusCovoiturageApplication\src\pages\search\search.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* MenuController */], __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]])
    ], SearchPage);
    return SearchPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common_http__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_fcm__ = __webpack_require__(199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__trip_details_trip_details__ = __webpack_require__(78);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_fcm__ = __webpack_require__(199);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_trip_details_trip_details__ = __webpack_require__(78);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__pages_trip_details_trip_details__["a" /* TripDetailsPage */]
            ],
            imports: [
...
var TripDetailsPage = /** @class */ (function () {
    function TripDetailsPage(httpClient, navCtrl, navParams) {
        ...
        if (navParams.get('userid') == undefined || navParams.get('userid') == null || navParams.get('userid') == "" || navParams.get('user_token') == undefined || navParams.get('user_token') == null || navParams.get('user_token') == "") {
            this.loadSearchData();
        }
        else {
    ...
    TripDetailsPage.prototype.loadSearchData = function () {
        var _this = this;
        this.response = this.httpClient.get('https://voisibus.fr/api/get/trip_details.php?trip=' + this.trip_id);
        this.response
            .subscribe(function (data) {
            _this.trip_details = data;
            _this.stops = JSON.parse(JSON.stringify(_this.trip_details))[0].stops.split(';');
    ...
    TripDetailsPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]])
    ], TripDetailsPage);
